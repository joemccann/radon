...
export default function AssetCockpit({
  ...
  // When the underlying is in focus, the order ticket acts on the STOCK (a fresh
  // order), not the held option — OrderTab renders its linear stock form for a
  // null position. The held option stays available everywhere else (header chip,
  // ACT summary, POSN deck).
