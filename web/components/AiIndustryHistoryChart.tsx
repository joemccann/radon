...
function History({ points, cadence, sourceLabel }: AiIndustryHistoryChartProps) {
  ...
  return <div className={styles.history} data-testid="ai-industry-history-chart">
    ...
    <p className={styles.note}>Drag the overview handles to change the visible range. Lines break across reporting gaps identified by source cadence or observed intervals. The overview spaces observations evenly; collection frequency is not market-session frequency.</p>
