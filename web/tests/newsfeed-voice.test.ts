...
describe("newsfeed voice", () => {
  it("uses a provisional evidenced voice with factual and instruction boundaries", () => {
    ...
    expect(NEWSFEED_VOICE_SYSTEM).toMatch(/short paragraphs/);
    expect(NEWSFEED_VOICE_SYSTEM).toMatch(/Never use bullet points/);
  ...
  it("turns rewritten X bullets into sentences in the assembled caption", () => {
