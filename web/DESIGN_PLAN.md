...
| Application shell | `components/WorkspaceShell.tsx`, `components/Header.tsx`, `components/Sidebar.tsx`, `lib/data.ts` | Replace the primary navigation composition and preserve the full route catalogue through secondary navigation and search. |
