...
| Kelly sizing spec (Fortune's Formula gap analysis, enforcement plan; default fraction 0.25 pending Joe) | [`docs/risk/kelly-fortunes-formula.md`](risk/kelly-fortunes-formula.md) |
