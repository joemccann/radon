...
| Kelly sizing spec (Fortune's Formula gap analysis, enforcement plan; Joe-signed default half Kelly 0.5 for the implement PR, 0.25 optional stricter) | [`docs/risk/kelly-fortunes-formula.md`](risk/kelly-fortunes-formula.md) |
