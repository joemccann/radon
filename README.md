...
- **Factory.** GitHub issues labeled `factory` become draft PRs via Foreman under `factory/`. Contract: [`docs/factory.md`](docs/factory.md).
...
├─ factory/              Foreman software factory (separate Vercel project)
