...
| **themarketear newsfeed** | laptop or Hetzner — headless Playwright (`THEMARKETEAR_EMAIL` + `THEMARKETEAR_PASSWORD`) | laptop or Hetzner — same; runs anywhere Chromium can launch |
