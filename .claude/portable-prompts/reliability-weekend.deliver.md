# reliability-weekend — deliver phase (portable prompt)
...
- **deliver:** your FINAL line of stdout must be exactly one of
      ...
      NIGHTLY DELIVER READY: loop=reliability prs=<n> <space-separated PR urls>
      NIGHTLY DELIVER INCOMPLETE: loop=reliability <one-line reason>
