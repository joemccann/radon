...
Title shape: `Documentation <YYYY-MM-DD>: <plain-language issue>`. Open or
update via `gh api -X PATCH repos/{owner}/{repo}/pulls/<n> --input <json>`
(this repo's `gh pr edit --body-file` aborts). Verify with a grep for a
phrase you just wrote.
